    ...
    <div>
      <div className="text-center text-redPrimary my-4">
        ...
        <div className="text-center">
          <a
            href="https://docs.google.com/forms/d/e/1FAIpQLSeo8aSUy1UcQYsd3PxLZsAbMWejKXIkQFviQYWnHzs-FT1rCA/viewform"
            ...
            {tableData.data.length > 0 ? (
              <div className="overflow-x-auto">
                <table className="w-full min-w-max bg-creamSecondary border-2 border-redPrimary table-auto text-black text-left shadow-lg">
                  <thead>
                    <tr>
                      {TABLE_HEAD.map((head) => (
                        <th
                          key={head}
                          className="border-b bg-redPrimary border-redPrimary p-4"
                        >
                  ...
                  <tbody>
                    {tableData.data.map(
                      ({ judul, peminjaman, pengembalian }, index) => {
              ...
              <div>
                ...
                <Typography className="text-redPrimary text-base text-center font-bold my-6">
      ...
      {error && (
        <Card className="my-6 mx-auto w-1/2 bg-transparent shadow-md border-2 border-redPrimary">
          <CardBody className="text-center">
            ...
            <Typography className="text-redPrimary text-base font-bold my-6">
              {error}
            </Typography>
          </CardBody>
        </Card>
