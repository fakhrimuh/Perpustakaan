    ...
    <div className=" bg-creamSecondary">
      <div className="container mx-auto">
        ...
        <div className="our-service text-center px-auto py-4">
          <p className="text-4xl font-bold mb-3 text-redPrimary">
            Layanan Kami
          </p>
          <div className="text-center mx-4 content-center grid xl:grid-cols-3 grid-rows-3 md:grid-cols-2">
            ...
            <a
              ...
              href="https://drive.google.com/file/d/15kJoTAS3jaWKXwhHfpMkYfDDdSAQWBvH/view"
            >
              <CardIcon
                title="Jurnal Tercetak"
                img1={AHJT}
                img2={BHJT}
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://docs.google.com/spreadsheets/u/2/d/e/2PACX-1vQKea1SIE-74RmJWPOM3BvMfBNhro1ZjaQAhEND0rG-YhiDxa-n6_zJ76K6okDLhbIFoW8RLyYnwiBW/pubhtml"
            >
              <CardIcon
                title="Paket Informasi"
                img1={AHPI}
                img2={BHPI}
                alternatif="Paket Informasi"
              />
            </a>
          </div>
        </div>
        ...
        <div className="quick-links text-center px-auto py-4">
          ...
          <div className="text-center mx-4 content-center grid xl:grid-cols-3  md:grid-cols-2">
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://drive.google.com/drive/folders/18V_n0LGoJmKuSGRLUoVhB6LZ0YfyhCY1"
            >
              <img
                src={PUM}
                alt="panduan unggah mandiri"
                className="h-full w-11/12 border-4 border-redPrimary rounded-xl"
              />
            </a>
            <Link to="/cekpeminjaman">
              <img
                src={PB}
                alt="cek peminjaman buku"
                className="h-full w-11/12 border-4 border-redPrimary rounded-xl "
              />
            </Link>
            <Link to="/usulanbuku">
