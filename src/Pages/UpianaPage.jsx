...
export default function Upiana() {
  ...
  // Fungsi pencarian
  const filteredData = TABLE_ROWS.filter((item) => item.judul.toLowerCase().includes(searchTerm.toLowerCase()));
    ...
    <div className="container mx-auto  mt-[115px]">
      <div className="my-4 text-center">
        ...
        <Typography variant="paragraph" className="my-2 w-3/4 mx-auto leading-normal font-medium text-redPrimary text-justify">
          Temukan koleksi lengkap jurnal dan E-book dari berbagai bidang ilmu dengan akses mudah dan terpercaya. Jelajahi artikel terkini dan kumpulan E-book untuk meningkatkan pengetahuan dan pemahaman Anda. Dapatkan manfaatnya dengan
          mengunduh E-book favorit Anda dan tetap terhubung dengan perkembangan terkini dalam dunia penelitian. Mari mulai petualangan membaca dengan konten yang menginspirasi dan mendidik.
        </Typography>
      </div>
            ...
            <thead>
              <tr>
                {TABLE_HEAD.map((head, index) => (
                  <th key={head} className="cursor-pointer border-redPrimary bg-creamSecondary p-4 transition-colors hover:bg-blue-gray-50">
                    <Typography variant="small" className="flex items-center justify-between gap-2 font-bold leading-none text-redPrimary">
        ...
        <CardFooter className="flex items-center justify-between border-t border-redPrimary p-4">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              className="flex gap-2 !border !border-redPrimary   text-redPrimary hover:bg-redPrimary hover:text-creamSecondary"
            >
              Next
