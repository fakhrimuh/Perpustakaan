  ...
  return (
    <div>
      ...
      <div className="text-center mx-4 content-center grid xl:grid-cols-7 grid-rows-3 md:grid-cols-2">
        <CardIcon title="FPEB" img1={AFPEB} img2={BFPEB} alternatif="Fakultas Pendidikan Ekonomi dan Bisnis" />
        <CardIcon title="FIP" img1={AFIP} img2={BFIP} alternatif="Fakultas Ilmu Pendidikan" />
        <CardIcon title="FPIPS" img1={AFPIPS} img2={BFPIPS} alternatif="Fakultas Pendidikan Ilmu Pengetahuan Sosial" />
        <CardIcon title="FPMIPA" img1={AFPMIPA} img2={BFPMIPA} alternatif="Fakultas Pendidikan Matematika dan Ilmu Pengetahuan Alam" />
        <CardIcon title="FPSD" img1={AFPSD} img2={BFPSD} alternatif="Fakultas Pendidikan Seni dan Desain" />
        <CardIcon title="FPTK" img1={AFPTK} img2={BFPTK} alternatif="Fakultas Pendidikan Teknologi dan Kejuruan" />
        <CardIcon title="Pasca Sarjana" img1={APS} img2={BPS} alternatif="Sekolah Pasca Sarjana" />
        <CardIcon title="Kampus Purwakarta" img1={ACampus} img2={BCampus} alternatif="UPI Kampus Purwakarta" />
        <CardIcon title="Kampus Serang" img1={ACampus} img2={BCampus} alternatif="UPI Kampus Serang" />
        <CardIcon title="Kampus Sumedang" img1={ACampus} img2={BCampus} alternatif="UPI Kampus Sumedang" />
        <CardIcon title="Kampus Tasik" img1={ACampus} img2={BCampus} alternatif="UPI Kampus Purwakarta" />
        <Link to="/FakultasPage">
          <CardIcon title="Kampus Cibiru" img1={ACampus} img2={BCampus} alternatif="UPI Kampus Cibiru" />
        </Link>
        <CardIcon title="FPBS" img1={AFPBS} img2={BFPBS} alternatif="Fakultas Pendidikan Bahasa dan Sastra" />
        <CardIcon title="FPOK" img1={AFPOK} img2={BFPOK} alternatif="Fakultas Pendidikan Olahraga dan Kejuruan" />
      </div>
    </div>
  );
}
